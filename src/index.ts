...
blockchain.addTransaction(new Transaction(wallet1.address, wallet2.address, 100));
blockchain.addTransaction(new Transaction(wallet1.address, wallet2.address, 50));
blockchain.addTransaction(new Transaction(wallet1.address, wallet2.address, 150));
blockchain.addTransaction(new Transaction(wallet1.address, wallet2.address, 200));
blockchain.addTransaction(new Transaction(wallet1.address, wallet2.address, 100)); // Ця транзакція повинна викликати майнінг
